 ...
 * - 1 <= stones[i] <= 100
 *
 * 此题与 lintcode 1798. Minimum Cost to Merge Stones 类似
 */
public class _1000_MinimumCostToMergeStones {

    // todo https://leetcode.com/problems/minimum-cost-to-merge-stones/discuss?currentPage=1&orderBy=most_votes&query=
