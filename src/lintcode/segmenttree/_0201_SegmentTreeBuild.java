 ...
 * attributes start & end denote an segment / interval.
 *
 * start & end are both integers, they should be assigned in following rules:
 * - The root's start & end is given by build method.
